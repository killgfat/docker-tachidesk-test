#!/bin/sh
if [ ! -f /tachidesk/.local/share/Tachidesk/docker_touchfile ]; then
	touch /tachidesk/.local/share/Tachidesk/docker_touchfile
	curl -s --create-dirs -L https://raw.githubusercontent.com/Suwayomi/docker-tachidesk/main/server.conf -o /tachidesk/.local/share/Tachidesk/server.conf;
fi
echo ""
echo ""
echo "                                                                ************README***********"
